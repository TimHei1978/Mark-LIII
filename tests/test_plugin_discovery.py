"""
Verifies our two plugins load through Mark-LII's REAL, unmodified
...
class PluginDiscoveryTests(unittest.TestCase):
    ...
    def test_both_plugins_are_discovered_as_valid(self):
    ...
    def test_dispatch_through_the_real_registry_reaches_our_run_function(self):
        ...
        wrapping/parameter-passing conventions are actually satisfied."""
        ...
        with patch("plugins.commercial_engine.requests.post") as mock_post, patch("plugins.commercial_engine.threading.Thread"):
            ...
            result = registry.run("create_video_production_request", {"product_name": "Kaffeebecher"}, player=None, session_memory=None)
